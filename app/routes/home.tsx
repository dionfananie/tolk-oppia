	...
	return (
		<MotionConfig reducedMotion="user">
			<div className="bg-paper text-ink">
				<header className="sticky top-0 z-[60] border-b border-line-soft bg-paper/85 backdrop-blur" style={{ height: '85px' }}>
					<div className="mx-auto h-full flex max-w-[1024px] items-center gap-6 px-4 sm:px-6">
						<Brand to="/" />
				...
				<section className="bg-ink text-surface">
					<RevealGroup className="mx-auto max-w-[1024px] px-4 pb-20 pt-[96px] text-center sm:px-6 md:pt-[132px]">
						<RevealItem>
				...
				<section id="how-it-works" className="py-16 md:py-24">
					<div className="mx-auto max-w-[1024px] px-4 sm:px-6">
						...
						<RevealGroup className="mt-12 grid gap-4 md:grid-cols-3">
							{STEPS.map((step) => (
								<RevealItem key={step.n} className="flex gap-4 rounded-lg border border-line bg-paper p-5">
					...
					<div className="mx-auto max-w-[1024px] px-4 sm:px-6">
						...
						<RevealGroup className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							{CATEGORY_ROWS.map((row) => (
								<RevealItem key={row.title} className="flex gap-4 rounded-lg border border-line bg-paper p-5">
				...
				<section id="voice" className="py-16 md:py-24">
					<div className="mx-auto grid max-w-[1024px] items-center gap-12 px-4 sm:px-6 md:grid-cols-[1.1fr_0.9fr]">
						...
						<Reveal delay={0.1} className="grid place-items-center">
				...
				<section id="feedback" className="bg-surface py-16 md:py-24">
					<div className="mx-auto grid max-w-[1024px] items-center gap-12 px-4 sm:px-6 md:grid-cols-[1.1fr_0.9fr]">
						...
						<Reveal delay={0.1} className="order-1 rounded-lg border border-line bg-paper p-6 md:order-2">
				...
				<section className="bg-ink text-surface">
					<Reveal className="mx-auto max-w-[1024px] px-4 py-24 text-center sm:px-6">
